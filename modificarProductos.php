...
<tr align="center">
    ...
    <td>
<a href="actualizarProductos.php?id=<?php echo $row["idProducto"]; ?>" class="table__item__link">Editar</a>
<a href="eliminarProductos.php?id=<?php echo $row["idProducto"]; ?>" class="table__item__link_eliminar">Eliminar</a>
</td>
</tr>
